...
app.layout = dmc.MantineProvider([
    dbc.Container([
        ...
        dbc.Tooltip(
            "Download a printable PDF of your deck. Ignore the security warning.",
            target="PDF-btn",
            placement="bottom",
            style={"fontSize": "0.95rem"}
        ),
...
def presentation_page():
    return dmc.Center(
        dmc.Stack([
            ...
            html.A("Learn more about the game in these Google Slides", href="https://docs.google.com/presentation/d/1z8EvBVcOxjh-tqTbaPtmv5BvFKnN5--I628QCtqlDOc/edit?slide=id.g39d59216dc3_0_117#slide=id.g39d59216dc3_0_117"),
            dmc.Text("Download printable pdf starter decks below:", size="md"),
            dmc.Group([
